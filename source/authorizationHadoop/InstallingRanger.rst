...
Рекомендуется хранить аудиты в Solr и HDFS. Обе эти опции по умолчанию установлены на ON. Solr предоставляет возможность индексирования и поиска по самым последним журналам, в то время как HDFS используется как более постоянный или более долгосрочный магазин. По умолчанию Solr используется для индексации предыдущих 30-дневных журналов аудита.


Рекомендуется хранить аудиты в Solr и HDFS. Оба эти параметры заданы по умолчанию. Solr предоставляет возможность индексирования и поиска по последним журналам, в то время как HDFS используется как более постоянное или более долгосрочное хранилище. По умолчанию Solr используется для индексирования предыдущих 30 дней журналов аудита.
