...
.. list-table:: Табл. 1. Минимальные системные требования для установки кластера Arenadata Ambari
   ...
   * - База данных
     - Ambari требует реляционную базу данных для хранения |br| 
       ...
       "Справочному руководству Ambari" для получения |br| 
       информации о возможных изменениях порта по умолчанию |br| 
       сервера Ambari.
       
       Использование параметров базы данных Microsoft SQL |br| 
       Server или SQL Anywhere не поддерживается.
       
       Если используется существующая база данных, развернутая |br| 
       на том же сервере, что и Ambari Server, необходимо, чтобы |br| 
       эта база работала на порте, отличном от 8080 |br| 
