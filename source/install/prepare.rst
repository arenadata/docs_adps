...
Хост **Ambari** должен иметь как минимум *1 ГБ* оперативной памяти и
...
Для **Ambari Server** необходимо, чтобы **Ambari Agents** были установлены на
...
сервером **Ambari** необходимо для учетной записи, под которой производится установка (по умолчанию от *root*), настроить беспарольное SSH-соединение между хостом **Ambari Server** и всеми другими хостами в кластере.
