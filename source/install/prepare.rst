...
.. list-table:: Табл. 1. Минимальные системные требования для установки кластера Arenadata Ambari
   ...
   * - База данных
     - Ambari требует реляционную базу данных для хранения |br| 
       ...
       тестирования окружающей среды, перенос базы данных Oozie |br| 
       из Derby в новую базу данных доступен только в |br| 
       Community Edition
       ...
       Это необходимо, чтобы избежать конфликта с портом Ambari, |br| 
       ...
       необходимо, чтобы эта база работала на порте, отличном |br| 
       от 8080 |br| 
