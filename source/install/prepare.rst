...
.. list-table:: Табл. 1. Минимальные системные требования для установки кластера Arenadata Ambari
   ...
   * - База данных
     - Ambari требует реляционную базу данных для хранения |br| 
       ...
       использоваться по умолчанию. Если планируется применение |br| 
       Derby для demo-версии, разработки или тестирования |br| 
       окружающей среды, перенос базы данных Oozie из Derby в |br| 
       ...
       на том же сервере, что и Ambari Server, необходимо, |br| 
       чтобы эта база работала на порте, отличном от 8080 |br| 
