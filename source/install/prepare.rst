...
максимального количества открытых файловых дескрипторов».123

.. list-table:: Табл.1. Минимальные системные требования для 
                 установки кластера Arenadata Ambari
...
зависимости от размера кластера (Табл. 2.).
