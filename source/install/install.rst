...
загрузить архив Ambari 2.2.1 в ранее созданный
...
:command:`tar -xzf /staging/AMBARI-2.2.*.tar -C /staging/`
...
:command:`/staging/AMBARI-2.2.1/setup_repo.sh`
...
:command:`curl http://localhost/AMBARI-2.2.1/repodata/repomd.xml`
