...
Кластеры из трех или более машин обычно используют один NameNode и ResourceManager со всеми другими узлами в качестве подчиненных. Кластер High-Availability (HA) использует первичный и вторичный NameNode, также как может использовать первичный и вторичный ResourceManager.
...
+ **Compute Intensive** -- ресурсоемкий
