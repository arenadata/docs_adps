...
+ Только на slave-узлах все партиции Hadoop должны устанавливаться индивидуально с дисков как */grid/[0-n]*;
...
+ Пример конфигурации Hadoop Slave Node Partitioning:
  ...
  + */grid/0/* -- (полный диск ГБ) первая партиция Hadoop для локального хранилища;

  + */grid/1/* -- вторая партиция Hadoop;
