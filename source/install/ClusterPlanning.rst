...
Желательно обеспечение множеством сетевых портов и пропускной способностью *10 ГБ* для коммутатора.
