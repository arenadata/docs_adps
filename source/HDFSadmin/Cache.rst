...
.. csv-table:: Табл. 8. Функции команды help
   ...
   "<command-name>", "Отображение подробной информации по указанной команде. Если |br| команда не указана, отображается подробная справка по всем командам"
...
.. csv-table:: Табл. 9. Функции команды addDirective
   ...
   "<time-to-live>", "Продолжительность действия директивы. Значение может быть указано в |br| минутах, часах и днях, например, *30 m*, *4 h*, *2 d*. Допустимыми единицами |br| являются [smhd]. Значение *never* означает, что директива никогда не истекает. |br| Если параметр не |br| установлен, директива никогда не истекает"
