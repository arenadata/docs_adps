...
.. csv-table:: Политика копирования
   :header: "ID |br| политики", "Название |br| политики |br| хранения", "Место |br| размещения копии |br| (для n копий)", "Резервное хранилище |br| для разработки", "Резервное хранилище |br| для копий"
