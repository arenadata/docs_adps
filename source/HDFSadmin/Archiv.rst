...
.. csv-table:: Табл. 3. Политика копирования
   :header: "ID политики", "Название политики |br| хранения", "Место размещения |br| копии |br| (для n копий)", "Резервное хранилище |br| для разработки", "Резервное хранилище |br| для копий"
