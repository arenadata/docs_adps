...
.. csv-table:: Политика хранения копий данных
   :header: "ID |br| политики", "Название политики", "Размещение блока |br| (для n реплик)", "Резервное |br| хранилище для |br| генерации", "Резервное |br| хранилище для |br| копирования"
