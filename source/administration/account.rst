...
Для перехода на экран настроек **Ambari** необходимо на главной странице перейти по пунктам меню панели управления :menuselection:`"admin --> Manage Ambari"` (см. :ref:`Рис.1.<admin-img-1>`). При этом открывается экран настроек **Ambari** (:ref:`Рис.2.<admin-img-2>`).
