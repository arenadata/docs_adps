...
.. glossary::
   ...
   Arenadata Unified Data Platform
      Универсальная платформа данных – это интегрированный набор 
   ...
   Кластер   
      Cluster — объединение нескольких однородных элементов, которое может 
   ...
   Стек  
      Stack — абстрактный тип данных, представляющий собой список 
      элементов,организованных по принципу LIFO (англ. last in — first 
   ...
   Компонент   
      Component — составная часть, элемент чего-либо
   ...
   DataNode 
      Программный код, как правило, выполняющийся на выделенной машине экземпляра 
      HDFS и отвечающий за операции уровня файла (работа с блоками данных);
      ...
      системы HDFS, т.к. данные проходят с остальных машин кластера к клиенту мимо 
      узла NameNode
   ...
   YARN
      ...
      обработки. Работать под управлением YARN могут как MapReduce-программы, 
