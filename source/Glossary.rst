...
.. glossary::
   ...
   Брандмауэр
      ...
      многие атаки на компьютер за счет фильтрации некоторых информационных
      пакетов
   ...
   NSCD
      Name Service Caching Daemon – это демон (сервис), который предоставляет кэш для наиболее 
      общих запросов службы имен. 
