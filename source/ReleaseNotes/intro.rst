...
В документе представлены официальные версии продуктов **Apache** в **ADH 1.5.2**. Все компоненты **ADH 1.5.2** являются наиболее стабильными версиями официальных релизов продуктов **Apache Software Foundation**.
