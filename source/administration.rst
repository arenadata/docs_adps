...
Для перехода на экран настроек Ambari необходимо на главной странице перейти по пунктам меню панели управления "admin – Manage Ambari" (`Рис.1.`). При этом открывается экран настроек Ambari.
